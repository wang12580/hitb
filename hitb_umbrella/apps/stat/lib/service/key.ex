defmodule Stat.Key do
  ...
  def enkey(key) do
    case key do
      ...
      "一般治疗占比" -> "ybzl_rate"
      "精神治疗占比" -> "jszl_rate"
      "心脏监护室（CCU）总人数" -> "ccu_num"
      "呼吸监护室（RICU）总人数" -> "ricu_num"
      "外科监护室（SICU）总人数" -> "sicu_num"
      "新生儿监护室（NICU）总人数" -> "nicu_num"
      "儿科监护室（PICU）总人数" -> "picu_num"
      "其他监护室总人数" -> "other_num"
      "心脏监护室（CCU）总人数占比" -> "ccu_rate"
      "呼吸监护室（RICU）总人数占比" -> "ricu_rate"
      "外科监护室（SICU）总人数占比" -> "sicu_rate"
      "新生儿监护室（NICU）总人数占比" -> "nicu_rate"
      "儿科监护室（PICU）总人数占比" -> "picu_rate"
      "其他监护室总人数占比" -> "other_rate"
      "实际开放总床日数" -> "sjkfzc_num"
      "实际占用总床日数" -> "sjzyzc_num"
      "出院者占用总床日数" -> "cyzzyzc_num"
      "平均开放病床数" -> "pjkfbc_num"
      "病床周转次数" -> "bczz_num"
      "病床工作日" -> "bcgzr_num"
      "出院者平均住院日" -> "cyzpjzy_num"
      "病床使用率" -> "bcsy_rate"
      "医疗使用病历数" -> "ylsy_num"
      "诊疗病历数" -> "zl_num"
      "诊疗占比" -> "zl_rate"
      ...
      "低风险组无尸检病历数" -> "wsj_num"
      "中低风险组病历数" -> "zdfx_num"
      "中低风险组死亡人数" -> "zdfxsw_num"
      "中低风险组死亡率" -> "zdfxsw_rate"
      "中低风险平均死亡年龄" -> "zdfx_age"
      "中低风险组有尸检病历数" -> "zdysj_num"
      "中低风险组无尸检病历数" -> "zdwsj_num"
      "中高风险组病历数" -> "zgfx_num"
      "中高风险组死亡人数" -> "zgfxsw_num"
      "中高风险组死亡率" -> "zgfxsw_rate"
      "中高风险平均死亡年龄" -> "zgfx_age"
      "中高风险组有尸检病历数" -> "zgysj_num"
      "中高风险组无尸检病历数" -> "zgwsj_num"
      "高风险组病历数" -> "gfx_num"
      "高风险组死亡人数" -> "gfxsw_num"
      "高风险组死亡率" -> "gfxsw_rate"
      "高风险组死亡年龄" -> "gfx_age"
      ...
      "一般治疗费占比" -> "ybzlf_rate"
      "精神治疗费占比" -> "jszlf_rate"
      "临床物理治疗费占比" -> "wlzlf_rate"
      "管理总额" -> "glze_expense"
      "监护及辅助呼吸费" -> "jhfz_expense"
      "床位费" -> "cw_expense"
      "挂号费" -> "gh_expense"
      "输氧费" -> "sy_expense"
      "其他费用" -> "other_expense"
      ...
      "白蛋白类制品费" -> "bdb_expense"
      "球蛋白类制品费" -> "qdb_expense"
      "凝血因子类制品费" -> "nxyz_expense"
      "细胞因子类制品费" -> "xbyz_expense"
      "例均输血费" -> "avg_sxf"
      "例均西药费" -> "avg_xyf"
      "例均抗菌药物费" -> "avg_kjy"
      "例均白蛋白类制品费" -> "avg_bdb"
      ...
      "白蛋白类制品费占比" -> "bdb_rate"
      "球蛋白类制品费占比" -> "qdb_rate"
      "凝血因子类制品费占比" -> "nxyz_rate"
      "细胞因子类制品费占比" -> "xbyz_rate"
      "药品总额" -> "ypzef"
      "治疗用一次性医用材料费" -> "zlyc_expense"
      "介入用一次性医用材料费" -> "jryc_expense"
      "手术用一次性医用材料费" -> "ssyc_expense"
      "检查用一次性医用材料费" -> "jcyc_expense"
      "耗材成本" -> "hc_expense"
      "例均药品费用" -> "avg_yp"
      "例均治疗用一次性医用材料费" -> "avg_zlyc"
      "例均介入用一次性医用材料费" -> "avg_jryc"
      "例均手术用一次性医用材料费" -> "avg_ssyc"
      "例均检查用一次性医用材料费" -> "avg_jcyc"
      "例均耗材成本" -> "avg_hc"
      "药品总额占比" -> "yp_rate"
      "治疗用一次性医用材料费占比" -> "zlyc_rate"
      "介入用一次性医用材料费占比" -> "jryc_rate"
      "手术用一次性医用材料费占比" -> "ssyc_rate"
      "检查用一次性医用材料费占比" -> "jcyc_rate"
      "耗材成本率" -> "hc_rate"
      "有出院31日再入院计划患者数" -> "is_inhosp31"
      "再住院计划患者率" -> "inhosp_rate"
      "出院当天再入院人数" -> "num_num1"
      "出院当天再入院率" -> "num_rate1"
      "2-15再入院人数" -> "num_num2"
      "2-15再入院率" -> "num_rate2"
      "16-31再入院人数" -> "num_num3"
      "16-31再入院人率" -> "num_rate3"
      "医嘱离院患者总人数" -> "yzly_num"
      "医嘱离院率" -> "yzly_rate"
      "医嘱转院患者总人数" -> "yzzy_num"
      "医嘱转院率" -> "yzzy_rate"
      "医嘱转社区卫生服务机构/乡镇卫生院患者总人数" -> "yzzsq_num"
      "医嘱转社区率" -> "yzzsq_rate"
      "非医嘱离院患者总人数" -> "fyzly_num"
      "非医嘱离院率" -> "fyzly_rate"
      "入院诊断与出院诊断符合人数" -> "rycyfh_num"
      "入院诊断与出院诊断符合率" -> "rycyfh_rate"
      "诊断与病理诊断符合人数" -> "zdblfh_num"
      ...
      "输液意外损伤人数" -> "syyw_num"
      "输液遗留体内异物人数" -> "syyl_num"
      "输液无菌预防措施的失败人数" -> "syyf_num"
      "输液时溶液稀释不当人数" -> "syry_num"
      "输液器械的污染人数" -> "sywr_num"
      "输液液体过量人数" -> "sygl_num"
      "护理负性事件患者总数占比" -> "hlfxsj_rate"
      "输液意外损伤人数占比" -> "syyw_rate"
      "输液遗留体内异物人数占比" -> "syyl_rate"
      "输液无菌预防措施的失败人数占比" -> "syyf_rate"
      "输液时溶液稀释不当人数占比" -> "syry_rate"
      "输液器械的污染人数占比" -> "sywr_rate"
      "输液液体过量人数占比" -> "sygl_rate"
      "输血负性事件患者总数" -> "sxfxsj_num"
      "输血意外损伤人数" -> "sxyw_num"
      "输血遗留体内异物人数" -> "sxyl_num"
      "输血无菌预防措施的失败人数" -> "sxyf_num"
      "输血器械的污染人数" -> "sxwr_num"
      "输血液体过量人数" -> "sxgl_num"
      "输血负性事件患者总数占比" -> "sxfxsj_rate"
      "输血意外损伤人数占比" -> "sxyw_rate"
      "输血遗留体内异物人数占比" -> "sxyl_rate"
      "输血无菌预防措施的失败人数占比" -> "sxyf_rate"
      "输血器械的污染人数占比" -> "sxwr_rate"
      "输血液体过量人数占比" -> "sxgl_rate"
      "压疮患者总数" -> "ychz_num"
      "Ⅰ度压疮患者数" -> "odyc_num"
      "Ⅱ度压疮患者数" -> "wdyc_num"
      "Ⅲ度压疮患者数" -> "tdyc_num"
      ...
      "Ⅳ度压疮患者占比" -> "fdyc_rate"
      "意外跌倒患者总数" -> "ywdd_num"
      "意外跌倒患者总数占比" -> "ycdd_rate"
      "坠床患者总数" -> "zc_num"
      "药物负性事件患者总数" -> "ywfxsj_num"
      "药物负性事件患者总数占比" -> "ywfxsj_rate"
      "药物过量人数" -> "ywgl_num"
      "药物过量占比" -> "ywgl_rate"
      "药物给错总人数" -> "ywgc_num"
      "药物给错总人数占比" -> "ywgc_rate"
      ...
      "术后平均住院日" -> "shday_num"
      "非计划再次手术例数" -> "fjh_num"
      "非计划再次手术例数占比" -> "fjh_rate"
      "重点手术例数" -> "zdss_num"
      "死亡例数" -> "sw_num"
      "死亡例数占比" -> "sw_rate"
      "切口裂开患者总人数" -> "qklk_num"
      "切口裂开患者总人数占比" -> "qklk_rate"
      "切口感染患者总人数" -> "qkgr_num"
      "切口感染率总人数占比" -> "qkgr_rate"
      "术后感染例数" -> "shgr_num"
      "术后感染例数占比" -> "shgr_rate"
      "术后并发症例数" -> "shbf_num"
      "术后并发症例数占比" -> "shbf_rate"
      "Ⅰ/甲切口愈合等级患者总人数" -> "yjqk_num"
      "Ⅰ/甲切口愈合等级患者总人数占比" -> "yjqk_rate"
      "Ⅱ/甲切切口愈合等级患者总人数" -> "ejqk_num"
      "Ⅱ/甲切切口愈合等级患者总人数占比" -> "ejqk_rate"
      "Ⅲ/甲切口愈合等级患者总人数" -> "sjqk_num"
      "Ⅲ/甲切口愈合等级患者总人数占比" -> "sjqk_rate"
      "有手术，但体表无切口患者总人数" -> "yss_num"
      "有手术，但体表无切口患者人数占比" -> "yss_rate"
      "Ⅰ/其他切口愈合等级患者总人数" -> "yjqtqk_num"
      "Ⅰ/其他切口愈合等级患者总人数占比" -> "yjqtqk_rate"
      "Ⅱ/其他切口愈合等级患者总人数" -> "ejqtqk_num"
      "Ⅱ/其他切口愈合等级患者总人数占比" -> "ejqtqk_rate"
      "Ⅲ/其他切口愈合等级患者总人数" -> "sjqtqk_num"
      "Ⅲ/其他切口愈合等级患者总人数占比" -> "sjqtqk_rate"
      "Ⅰ/乙切口愈合等级患者总人数" -> "yjyqk_num"
      "Ⅰ/乙切口愈合等级患者总人数占比" -> "yjyqk_rate"
      "Ⅱ/乙切切口愈合等级患者总人数" -> "ejyqk_num"
      "Ⅱ/乙切切口愈合等级患者总人数占比" -> "ejyqk_rate"
      "Ⅲ/乙切口愈合等级患者总人数" -> "sjyqk_num"
      "Ⅲ/乙切口愈合等级患者总人数占比" -> "sjyqk_rate"
      "Ⅰ/丙切口愈合等级患者总人数" -> "yjbqk_num"
      "Ⅰ/丙切口愈合等级患者总人数占比" -> "yjbqk_rate"
      "Ⅱ/丙切口愈合等级患者总人数" -> "ejbqk_num"
      "Ⅱ/丙切口愈合等级患者总人数占比" -> "ejbqk_rate"
      "Ⅲ/丙切口愈合等级患者总人数" -> "sjbqk_num"
      "Ⅲ/丙切口愈合等级患者总人数占比" -> "sjbqk_rate"
      "一级手术患者总人数" -> "ojss_num"
      "一级手术患者总人数占比" -> "ojss_rate"
      "二级手术患者总人数" -> "wjss_num"
      "二级手术患者总人数占比" -> "wjss_rate"
      "三级手术患者总人数" -> "tjss_num"
      "三级手术患者总人数占比" -> "tjss_rate"
      "四级手术患者总人数" -> "fjss_num"
      "四级手术患者总人数占比" -> "fjss_rate"
      "病案质量为甲级病案总数" -> "bazlj_num"
      "病案质量为甲级病案总数占比" -> "bazlj_rate"
      "病案质量为乙级病案总数" -> "bazly_num"
      "病案质量为乙级病案总数占比" -> "bazly_rate"
      "病案质量为丙级病案总数" -> "bazlb_num"
      "病案质量为丙级病案总数占比" -> "bazlb_rate"
      "肿瘤患者T0期总人数" -> "tl_num"
      "肿瘤患者T1期总人数" -> "to_num"
      "肿瘤患者T2期总人数" -> "tw_num"
      "肿瘤患者T3期总人数" -> "tt_num"
      "肿瘤患者T4期总人数" -> "tf_num"
      "肿瘤患者无法评估原发肿瘤大小总人数" -> "wfpgyf_num"
      "肿瘤患者T0期总人数占比" -> "tl_rate"
      "肿瘤患者T1期总人数占比" -> "to_rate"
      "肿瘤患者T2期总人数占比" -> "tw_rate"
      "肿瘤患者T3期总人数占比" -> "tt_rate"
      "肿瘤患者T4期总人数占比" -> "tf_rate"
      "肿瘤患者无法评估原发肿瘤大小总人数占比" -> "wfpgyf_rate"
      "肿瘤患者N0期总人数" -> "nl_num"
      "肿瘤患者N1期总人数" -> "no_num"
      "肿瘤患者N2期总人数" -> "nw_num"
      "肿瘤患者N3期总人数" -> "nt_num"
      "肿瘤患者N4期总人数" -> "nf_num"
      "肿瘤患者无法评估区域淋巴结有无转移总人数" -> "wfpglb_num"
      "肿瘤患者N0期总人数占比" -> "nl_rate"
      "肿瘤患者N1期总人数占比" -> "no_rate"
      "肿瘤患者N2期总人数占比" -> "nw_rate"
      "肿瘤患者N3期总人数占比" -> "nt_rate"
      "肿瘤患者N4期总人数占比" -> "nf_rate"
      "肿瘤患者无法评估区域淋巴结有无转移总人数占比" -> "wfpglb_rate"
      "肿瘤患者M0期总人数" -> "ml_num"
      "肿瘤患者M0期总人数占比" -> "ml_rate"
      "肿瘤患者M1期总人数" -> "mo_num"
      "肿瘤患者M1期总人数占比" -> "mo_rate"
      "肿瘤患者无法评估远处是否转移总人数" -> "wfpgyc_num"
      "肿瘤患者无法评估远处是否转移总人数占比" -> "wfpgyc_rate"
      "男性患者" -> "man_num"
      "男性患者占比" -> "man_rate"
      "女性患者" -> "woman_num"
      "女性患者占比" -> "woman_rate"
      ...
      "神经系统总人数占比" -> "sjxt_rate"
      "呼吸系统总人数占比" -> "hxxt_rate"
      "血液循环系统总人数占比" -> "xyxh_rate"
      "运动系统总人数占比" -> "ydxt_rate"
      "内分泌系统总人数占比" -> "nfm_rate"
      "泌尿系统总人数占比" -> "mnxt_rate"
      "生殖系统总人数占比" -> "szxt_rate"
      "肿瘤分期不详患者总人数" -> "zlfq_num"
      "高分化程度患者总人数" -> "gfh_num"
      "中分化程度患者总人数" -> "zfh_num"
      "低分化程度患者总人数" -> "dfh_num"
      "未分化程度患者总人数" -> "wfh_num"
      "未确定程度患者总人数" -> "wqd_num"
      "肿瘤分期不详患者总人数占比" -> "zlfq_rate"
      "高分化程度患者总人数占比" -> "gfh_rate"
      "中分化程度患者总人数占比" -> "zfh_rate"
      "低分化程度患者总人数占比" -> "dfh_rate"
      "未分化程度患者总人数占比" -> "wfh_rate"
      "未确定程度患者总人数占比" -> "wqd_rate"
      "T细胞程度患者总人数" -> "txb_num"
      "T细胞程度患者总人数占比" -> "txb_rate"
      "B细胞程度患者总人数" -> "bxb_num"
      "B细胞程度患者总人数占比" -> "bxb_rate"
      "非T-非B程度患者总人数" -> "ftfbxb_num"
      "非T-非B程度患者总人数占比" -> "ftfbxb_rate"
      "NK（自然杀伤）细胞程度患者总人数" -> "nk_num"
      "NK（自然杀伤）细胞程度患者总人数占比" -> "nk_rate"
      "临床诊断作为最高诊断依据患者总人数" -> "lczg_num"
      "X线、CT、超声波、内窥镜等诊断作为最高诊断依据患者总人数" -> "xxct_num"
      "手术诊断作为最高诊断依据患者总人数" -> "sszd_num"
      "生化、免疫诊断作为最高诊断依据患者总人数" -> "shmy_num"
      "细胞学、血片诊断作为最高诊断依据患者总人数" -> "xbx_num"
      "病理（继发）诊断作为最高诊断依据患者总人数" -> "bljf_num"
      "病理（原发）诊断作为最高诊断依据患者总人数" -> "blyf_num"
      "尸检（有病理）诊断作为最高诊断依据患者总人数" -> "sjybl_num"
      "最高诊断依据不详患者总人数" -> "zgzdyj_num"
      "临床诊断作为最高诊断依据患者总人数占比" -> "lczg_rate"
      "X线、CT、超声波、内窥镜等诊断作为最高诊断依据患者总人数占比" -> "xxct_rate"
      "手术诊断作为最高诊断依据患者总人数占比" -> "sszd_rate"
      "生化、免疫诊断作为最高诊断依据患者总人数占比" -> "shmy_rate"
      "细胞学、血片诊断作为最高诊断依据患者总人数占比" -> "xbx_rate"
      "病理（继发）诊断作为最高诊断依据患者总人数占比" -> "bljf_rate"
      "病理（原发）诊断作为最高诊断依据患者总人数占比" -> "blyf_rate"
      "尸检（有病理）诊断作为最高诊断依据患者总人数占比" -> "sjybl_rate"
      "最高诊断依据不详患者总人数占比" -> "zgzdyj_rate"
      "RH阴性_A型血型患者总人数" -> "rhya_num"
      "RH阴性_A型血型患者总人数占比" -> "rhya_rate"
      "RH阴性_B型血型患者总人数" -> "rhyb_num"
      "RH阴性_B型血型患者总人数占比" -> "rhyb_rate"
      "RH阴性_O型血型患者总人数" -> "rhyo_num"
      "RH阴性_O型血型患者总人数占比" -> "rhyo_rate"
      "RH阴性_AB型血型患者总人数" -> "rhyab_num"
      "RH阴性_AB型血型患者总人数占比" -> "rhyab_rate"
      "RH不详_A型血型患者总人数" -> "rhbxa_num"
      "RH不详_A型血型患者总人数占比" -> "rhbxa_rate"
      "RH不详_B型血型患者总人数" -> "rhbxb_num"
      "RH不详_B型血型患者总人数占比" -> "rhbxb_rate"
      "RH不详_O型血型患者总人数" -> "rhbxo_num"
      "RH不详_O型血型患者总人数占比" -> "rhbxo_rate"
      "RH不详_AB型血型患者总人数" -> "rhbxab_num"
      "RH不详_AB型血型患者总人数占比" -> "rhbxab_rate"
      "RH阳性_A型血型患者总人数" -> "rhyxa_num"
      "RH阳性_A型血型患者总人数占比" -> "rhyxa_rate"
      "RH阳性_B型血型患者总人数" -> "rhyxb_num"
      "RH阳性_B型血型患者总人数占比" -> "rhyxb_rate"
      "RH阳性_O型血型患者总人数" -> "rhyxo_num"
      "RH阳性_O型血型患者总人数占比" -> "rhyxo_rate"
      "RH阳性_AB型血型患者总人数" -> "rhyxab_num"
      "RH阳性_AB型血型患者总人数占比" -> "rhyxab_rate"
      "Rh阳性_A型血型使用总单位数" -> "rhyxa_cc"
      "Rh阳性_B型血型使用总单位数" -> "rhyxb_cc"
      "Rh阳性_AB型血型使用总单位数" -> "rhyxab_cc"
      "Rh阳性_O型血型使用总单位数" -> "rhyxo_cc"
      "Rh阳性_A型血型使用总单位数占比" -> "rhyxacc_rate"
      "Rh阳性_B型血型使用总单位数占比" -> "rhyxbcc_rate"
      "Rh阳性_AB型血型使用总单位数占比" -> "rhyxabcc_rate"
      "Rh阳性_O型血型使用总单位数占比" -> "rhyx0cc_rate"
      "Rh阴性_A型血型使用总单位数占比" -> "rhyacc_rate"
      "Rh阴性_B型血型使用总单位数占比" -> "rhybcc_rate"
      "Rh阴性_AB型血型使用总单位数占比" -> "rhyabcc_rate"
      "Rh阴性_O型血型使用总单位数占比" -> "rhy0cc_rate"
      "Rh阴性_A型血型使用总单位数" -> "rhya_cc"
      "Rh阴性_B型血型使用总单位数" -> "rhyb_cc"
      "Rh阴性_AB型血型使用总单位数" -> "rhyab_cc"
      "Rh阴性_O型血型使用总单位数" -> "rhyo_cc"
      "成分血总单位数" -> "cfx_num"
      "红细胞使用总单位数" -> "hxb_num"
      "血小板使用总单位数" -> "xsb_num"
      "血浆使用总单位数" -> "xj_num"
      ...
      "例均血浆使用总单位数" -> "xj_avg"
      "例均全血使用总单位数" -> "qx_avg"
      "例均其它血制品使用总单位数" -> "qtx_avg"
      "分析病历数" -> "sum_rate"
      "成分血总单位数占比" -> "cfx_rate"
      "红细胞使用总单位数占比" -> "hxb_rate"
      "血小板使用总单位数占比" -> "xsb_rate"
      "血浆使用总单位数占比" -> "xj_rate"
      "全血使用总单位数占比" -> "qx_rate"
      "其它血制品使用总单位数占比" -> "qtx_rate"
      "本市城镇职工基本医疗保险患者支付总额" -> "bszg_num"
      "本市城镇职工基本医疗保险患者自付总额" -> "bszgzf_num"
      "本市城镇职工基本医疗保险患者医疗总额" -> "bszgyl_num"
      "本市城镇职工基本医疗保险患者医技总额" -> "bszgyj_num"
      "本市城镇职工基本医疗保险患者药品总额" -> "bszgypj_num"
      "本市城镇职工基本医疗保险患者护理总额" -> "bszghl_num"
      "本市城镇职工基本医疗保险患者管理总额" -> "bszggl_num"
      "本市城镇职工基本医疗保险患者例均支付总额" -> "bszg_avg"
      "本市城镇职工基本医疗保险患者例均自付总额" -> "bszgzf_avg"
      "本市城镇职工基本医疗保险患者例均医疗总额" -> "bszgyl_avg"
      "本市城镇职工基本医疗保险患者例均医技总额" -> "bszgyj_avg"
      "本市城镇职工基本医疗保险患者例均药品总额" -> "bszgypj_avg"
      "本市城镇职工基本医疗保险患者例均护理总额" -> "bszghl_avg"
      "本市城镇职工基本医疗保险患者例均管理总额" -> "bszggl_avg"
      "本市城镇职工基本医疗保险患者支付总额占比" -> "bszg_rate"
      "本市城镇职工基本医疗保险患者自付总额占比" -> "bszgzf_rate"
      "本市城镇职工基本医疗保险患者医疗总额占比" -> "bszgyl_rate"
      "本市城镇职工基本医疗保险患者医技总额占比" -> "bszgyj_rate"
      "本市城镇职工基本医疗保险患者药品总额占比" -> "bszgypj_rate"
      "本市城镇职工基本医疗保险患者护理总额占比" -> "bszghl_rate"
      "本市城镇职工基本医疗保险患者管理总额占比" -> "bszggl_rate"
      "外埠城镇职工基本医疗保险患者支付总额" -> "wbzg_num"
      "外埠城镇职工基本医疗保险患者自付总额" -> "wbzgzf_num"
      "外埠城镇职工基本医疗保险患者医疗总额" -> "wbzgyl_num"
      "外埠城镇职工基本医疗保险患者医技总额" -> "wbzgyj_num"
      "外埠城镇职工基本医疗保险患者药品总额" -> "wbzgypj_num"
      "外埠城镇职工基本医疗保险患者护理总额" -> "wbzghl_num"
      "外埠城镇职工基本医疗保险患者管理总额" -> "wbzggl_num"
      "外埠城镇职工基本医疗保险患者例均支付总额" -> "wbzg_avg"
      "外埠城镇职工基本医疗保险患者例均自付总额" -> "wbzgzf_avg"
      "外埠城镇职工基本医疗保险患者例均医疗总额" -> "wbzgyl_avg"
      "外埠城镇职工基本医疗保险患者例均医技总额" -> "wbzgyj_avg"
      "外埠城镇职工基本医疗保险患者例均药品总额" -> "wbzgypj_avg"
      "外埠城镇职工基本医疗保险患者例均护理总额" -> "wbzghl_avg"
      "外埠城镇职工基本医疗保险患者例均管理总额" -> "wbzggl_avg"
      "外埠城镇职工基本医疗保险患者支付总额占比" -> "wbzg_rate"
      "外埠城镇职工基本医疗保险患者自付总额占比" -> "wbzgzf_rate"
      "外埠城镇职工基本医疗保险患者医疗总额占比" -> "wbzgyl_rate"
      "外埠城镇职工基本医疗保险患者医技总额占比" -> "wbzgyj_rate"
      "外埠城镇职工基本医疗保险患者药品总额占比" -> "wbzgypj_rate"
      "外埠城镇职工基本医疗保险患者护理总额占比" -> "wbzghl_rate"
      "外埠城镇职工基本医疗保险患者管理总额占比" -> "wbzggl_rate"
      "本市城镇居民基本医疗保险患者支付总额" -> "bsjm_num"
      "本市城镇居民基本医疗保险患者自付总额" -> "bsjmzf_num"
      "本市城镇居民基本医疗保险患者医疗总额" -> "bsjmyl_num"
      "本市城镇居民基本医疗保险患者医技总额" -> "bsjmyj_num"
      "本市城镇居民基本医疗保险患者药品总额" -> "bsjmypj_num"
      "本市城镇居民基本医疗保险患者护理总额" -> "bsjmhl_num"
      "本市城镇居民基本医疗保险患者管理总额" -> "bsjmgl_num"
      "本市城镇居民基本医疗保险患者例均支付总额" -> "bsjm_avg"
      "本市城镇居民基本医疗保险患者例均自付总额" -> "bsjmzf_avg"
      "本市城镇居民基本医疗保险患者例均医疗总额" -> "bsjmyl_avg"
      "本市城镇居民基本医疗保险患者例均医技总额" -> "bsjmyj_avg"
      "本市城镇居民基本医疗保险患者例均药品总额" -> "bsjmypj_avg"
      "本市城镇居民基本医疗保险患者例均护理总额" -> "bsjmhl_avg"
      "本市城镇居民基本医疗保险患者例均管理总额" -> "bsjmgl_avg"
      "本市城镇居民基本医疗保险患者支付总额占比" -> "bsjm_rate"
      "本市城镇居民基本医疗保险患者自付总额占比" -> "bsjmzf_rate"
      "本市城镇居民基本医疗保险患者医疗总额占比" -> "bsjmyl_rate"
      "本市城镇居民基本医疗保险患者医技总额占比" -> "bsjmyj_rate"
      "本市城镇居民基本医疗保险患者药品总额占比" -> "bsjmypj_rate"
      "本市城镇居民基本医疗保险患者护理总额占比" -> "bsjmhl_rate"
      "本市城镇居民基本医疗保险患者管理总额占比" -> "bsjmgl_rate"
      "外埠城镇居民基本医疗保险患者支付总额" -> "wbjm_num"
      "外埠城镇居民基本医疗保险患者自付总额" -> "wbjmzf_num"
      "外埠城镇居民基本医疗保险患者医疗总额" -> "wbjmyl_num"
      "外埠城镇居民基本医疗保险患者医技总额" -> "wbjmyj_num"
      "外埠城镇居民基本医疗保险患者药品总额" -> "wbjmypj_num"
      "外埠城镇居民基本医疗保险患者护理总额" -> "wbjmhl_num"
      "外埠城镇居民基本医疗保险患者管理总额" -> "wbjmgl_num"
      "外埠城镇居民基本医疗保险患者例均支付总额" -> "wbjm_avg"
      "外埠城镇居民基本医疗保险患者例均自付总额" -> "wbjmzf_avg"
      "外埠城镇居民基本医疗保险患者例均医疗总额" -> "wbjmyl_avg"
      "外埠城镇居民基本医疗保险患者例均医技总额" -> "wbjmyj_avg"
      "外埠城镇居民基本医疗保险患者例均药品总额" -> "wbjmypj_avg"
      "外埠城镇居民基本医疗保险患者例均护理总额" -> "wbjmhl_avg"
      "外埠城镇居民基本医疗保险患者例均管理总额" -> "wbjmgl_avg"
      "外埠城镇居民基本医疗保险患者支付总额占比" -> "wbjm_rate"
      "外埠城镇居民基本医疗保险患者自付总额占比" -> "wbjmzf_rate"
      "外埠城镇居民基本医疗保险患者医疗总额占比" -> "wbjmyl_rate"
      "外埠城镇居民基本医疗保险患者医技总额占比" -> "wbjmyj_rate"
      "外埠城镇居民基本医疗保险患者药品总额占比" -> "wbjmypj_rate"
      "外埠城镇居民基本医疗保险患者护理总额占比" -> "wbjmhl_rate"
      "外埠城镇居民基本医疗保险患者管理总额占比" -> "wbjmgl_rate"
      "本市新型农村合作医疗患者支付总额" -> "bsxnh_num"
      "本市新型农村合作医疗患者自付总额" -> "bsxnhzf_num"
      "本市新型农村合作医疗患者医疗总额" -> "bsxnhyl_num"
      "本市新型农村合作医疗患者医技总额" -> "bsxnhyj_num"
      "本市新型农村合作医疗患者药品总额" -> "bsxnhypj_num"
      "本市新型农村合作医疗患者护理总额" -> "bsxnhhl_num"
      "本市新型农村合作医疗患者管理总额" -> "bsxnhgl_num"
      "本市新型农村合作医疗患者例均支付总额" -> "bsxnh_avg"
      "本市新型农村合作医疗患者例均自付总额" -> "bsxnhzf_avg"
      "本市新型农村合作医疗患者例均医疗总额" -> "bsxnhyl_avg"
      "本市新型农村合作医疗患者例均医技总额" -> "bsxnhyj_avg"
      "本市新型农村合作医疗患者例均药品总额" -> "bsxnhypj_avg"
      "本市新型农村合作医疗患者例均护理总额" -> "bsxnhhl_avg"
      "本市新型农村合作医疗患者例均管理总额" -> "bsxnhgl_avg"
      "本市新型农村合作医疗患者支付总额占比" -> "bsxnh_rate"
      "本市新型农村合作医疗患者自付总额占比" -> "bsxnhzf_rate"
      "本市新型农村合作医疗患者医疗总额占比" -> "bsxnhyl_rate"
      "本市新型农村合作医疗患者医技总额占比" -> "bsxnhyj_rate"
      "本市新型农村合作医疗患者药品总额占比" -> "bsxnhypj_rate"
      "本市新型农村合作医疗患者护理总额占比" -> "bsxnhhl_rate"
      "本市新型农村合作医疗患者管理总额占比" -> "bsxnhgl_rate"
      "外埠新型农村合作医疗患者支付总额" -> "wbxnh_num"
      "外埠新型农村合作医疗患者自付总额" -> "wbxnhzf_num"
      "外埠新型农村合作医疗患者医疗总额" -> "wbxnhyl_num"
      "外埠新型农村合作医疗患者医技总额" -> "wbxnhyj_num"
      "外埠新型农村合作医疗患者药品总额" -> "wbxnhypj_num"
      "外埠新型农村合作医疗患者护理总额" -> "wbxnhhl_num"
      "外埠新型农村合作医疗患者管理总额" -> "wbxnhgl_num"
      "外埠新型农村合作医疗患者例均支付总额" -> "wbxnh_avg"
      "外埠新型农村合作医疗患者例均自付总额" -> "wbxnhzf_avg"
      "外埠新型农村合作医疗患者例均医疗总额" -> "wbxnhyl_avg"
      "外埠新型农村合作医疗患者例均医技总额" -> "wbxnhyj_avg"
      "外埠新型农村合作医疗患者例均药品总额" -> "wbxnhypj_avg"
      "外埠新型农村合作医疗患者例均护理总额" -> "wbxnhhl_avg"
      "外埠新型农村合作医疗患者例均管理总额" -> "wbxnhgl_avg"
      "外埠新型农村合作医疗患者支付总额占比" -> "wbxnh_rate"
      "外埠新型农村合作医疗患者自付总额占比" -> "wbxnhzf_rate"
      "外埠新型农村合作医疗患者医疗总额占比" -> "wbxnhyl_rate"
      "外埠新型农村合作医疗患者医技总额占比" -> "wbxnhyj_rate"
      "外埠新型农村合作医疗患者药品总额占比" -> "wbxnhypj_rate"
      "外埠新型农村合作医疗患者护理总额占比" -> "wbxnhhl_rate"
      "外埠新型农村合作医疗患者管理总额占比" -> "wbxnhgl_rate"
      "贫困救助患者支付总额" -> "pkjz_num"
      "贫困救助患者自付总额" -> "pkjzzf_num"
      "贫困救助医疗总额" -> "pkjzyl_num"
      "贫困救助医技总额" -> "pkjzyj_num"
      "贫困救助药品总额" -> "pkjzypj_num"
      "贫困救助护理总额" -> "pkjzhl_num"
      "贫困救助管理总额" -> "pkjzgl_num"
      "贫困救助患者例均支付总额" -> "pkjz_avg"
      "贫困救助患者例均自付总额" -> "pkjzzf_avg"
      "贫困救助例均医疗总额" -> "pkjzyl_avg"
      "贫困救助例均医技总额" -> "pkjzyj_avg"
      "贫困救助例均药品总额" -> "pkjzypj_avg"
      "贫困救助例均护理总额" -> "pkjzhl_avg"
      "贫困救助例均管理总额" -> "pkjzgl_avg"
      "贫困救助患者支付总额占比" -> "pkjz_rate"
      "贫困救助患者自付总额占比" -> "pkjzzf_rate"
      "贫困救助医疗总额占比" -> "pkjzyl_rate"
      "贫困救助医技总额占比" -> "pkjzyj_rate"
      "贫困救助药品总额占比" -> "pkjzypj_rate"
      "贫困救助护理总额占比" -> "pkjzhl_rate"
      "贫困救助管理总额占比" -> "pkjzgl_rate"
      "商业医疗保险患者支付总额" -> "sybx_num"
      "商业医疗保险患者自付总额" -> "sybxzf_num"
      "商业医疗保险患者医疗总额" -> "sybxyl_num"
      "商业医疗保险患者医技总额" -> "sybxyj_num"
      "商业医疗保险患者药品总额" -> "sybxypj_num"
      "商业医疗保险患者护理总额" -> "sybxhl_num"
      "商业医疗保险患者管理总额" -> "sybxgl_num"
      "商业医疗保险患者例均支付总额" -> "sybx_avg"
      "商业医疗保险患者例均自付总额" -> "sybxzf_avg"
      "商业医疗保险患者例均医疗总额" -> "sybxyl_avg"
      "商业医疗保险患者例均医技总额" -> "sybxyj_avg"
      "商业医疗保险患者例均药品总额" -> "sybxypj_avg"
      "商业医疗保险患者例均护理总额" -> "sybxhl_avg"
      "商业医疗保险患者例均管理总额" -> "sybxgl_avg"
      "商业医疗保险患者支付总额占比" -> "sybx_rate"
      "商业医疗保险患者自付总额占比" -> "sybxzf_rate"
      "商业医疗保险患者医疗总额占比" -> "sybxyl_rate"
      "商业医疗保险患者医技总额占比" -> "sybxyj_rate"
      "商业医疗保险患者药品总额占比" -> "sybxypj_rate"
      "商业医疗保险患者护理总额占比" -> "sybxhl_rate"
      "商业医疗保险患者管理总额占比" -> "sybxgl_rate"
      "全公费患者支付总额" -> "qgf_num"
      "全公费患者自付总额" -> "qgfzf_num"
      "全公费患者医疗总额" -> "qgfyl_num"
      "全公费患者医技总额" -> "qgfyj_num"
      "全公费患者药品总额" -> "qgfypj_num"
      "全公费患者护理总额" -> "qgfhl_num"
      "全公费患者管理总额" -> "qgfgl_num"
      "全公费患者例均支付总额" -> "qgf_avg"
      "全公费患者例均自付总额" -> "qgfzf_avg"
      "全公费患者例均医疗总额" -> "qgfyl_avg"
      "全公费患者例均医技总额" -> "qgfyj_avg"
      "全公费患者例均药品总额" -> "qgfypj_avg"
      "全公费患者例均护理总额" -> "qgfhl_avg"
      "全公费患者例均管理总额" -> "qgfgl_avg"
      "全公费患者支付总额占比" -> "qgf_rate"
      "全公费患者自付总额占比" -> "qgfzf_rate"
      "全公费患者医疗总额占比" -> "qgfyl_rate"
      "全公费患者医技总额占比" -> "qgfyj_rate"
      "全公费患者药品总额占比" -> "qgfypj_rate"
      "全公费患者护理总额占比" -> "qgfhl_rate"
      "全公费患者管理总额占比" -> "qgfgl_rate"
      "全自费患者支付总额" -> "qzf_num"
      "全自费患者医疗总额" -> "qzfyl_num"
      "全自费患者医技总额" -> "qzfyj_num"
      "全自费患者药品总额" -> "qzfypj_num"
      "全自费患者护理总额" -> "qzfhl_num"
      "全自费患者管理总额" -> "qzfgl_num"
      "全自费患者例均支付总额" -> "qzf_avg"
      "全自费患者例均医疗总额" -> "qzfyl_avg"
      "全自费患者例均医技总额" -> "qzfyj_avg"
      "全自费患者例均药品总额" -> "qzfypj_avg"
      "全自费患者例均护理总额" -> "qzfhl_avg"
      "全自费患者例均管理总额" -> "qzfgl_avg"
      "全自费患者支付总额占比" -> "qzf_rate"
      "全自费患者医疗总额占比" -> "qzfyl_rate"
      "全自费患者医技总额占比" -> "qzfyj_rate"
      "全自费患者药品总额占比" -> "qzfypj_rate"
      "全自费患者护理总额占比" -> "qzfhl_rate"
      "全自费患者管理总额占比" -> "qzfgl_rate"
      "其他社会保险患者支付总额" -> "qtbx_num"
      "其他社会保险患者自付总额" -> "qtbxzf_num"
      "其他社会保险医疗总额" -> "qtbxyl_num"
      "其他社会保险医技总额" -> "qtbxyj_num"
      "其他社会保险药品总额" -> "qtbxypj_num"
      "其他社会保险护理总额" -> "qtbxhl_num"
      "其他社会保险管理总额" -> "qtbxgl_num"
      "其他社会保险患者例均支付总额" -> "qtbx_avg"
      "其他社会保险患者例均自付总额" -> "qtbxzf_avg"
      "其他社会保险例均医疗总额" -> "qtbxyl_avg"
      "其他社会保险例均医技总额" -> "qtbxyj_avg"
      "其他社会保险例均药品总额" -> "qtbxypj_avg"
      "其他社会保险例均护理总额" -> "qtbxhl_avg"
      "其他社会保险例均管理总额" -> "qtbxgl_avg"
      "其他社会保险患者支付总额占比" -> "qtbx_rate"
      "其他社会保险患者自付总额占比" -> "qtbxzf_rate"
      "其他社会保险医疗总额占比" -> "qtbxyl_rate"
      "其他社会保险医技总额占比" -> "qtbxyj_rate"
      "其他社会保险药品总额占比" -> "qtbxypj_rate"
      "其他社会保险护理总额占比" -> "qtbxhl_rate"
      "其他社会保险管理总额占比" -> "qtbxgl_rate"
      "其他患者支付总额" -> "qthz_num"
      "其他患者自付总额" -> "qthzzf_num"
      "其他患者医疗总额" -> "qthzyl_num"
      "其他患者医技总额" -> "qthzyj_num"
      "其他患者药品总额" -> "qthzypj_num"
      "其他患者护理总额" -> "qthzhl_num"
      "其他患者管理总额" -> "qthzgl_num"
      "其他患者例均支付总额" -> "qthz_avg"
      "其他患者例均自付总额" -> "qthzzf_avg"
      "其他患者例均医疗总额" -> "qthzyl_avg"
      "其他患者例均医技总额" -> "qthzyj_avg"
      "其他患者例均药品总额" -> "qthzypj_avg"
      "其他患者例均护理总额" -> "qthzhl_avg"
      "其他患者例均管理总额" -> "qthzgl_avg"
      "其他患者支付总额占比" -> "qthz_rate"
      "其他患者自付总额占比" -> "qthzzf_rate"
      "其他患者医疗总额占比" -> "qthzyl_rate"
      "其他患者医技总额占比" -> "qthzyj_rate"
      "其他患者药品总额占比" -> "qthzypj_rate"
      "其他患者护理总额占比" -> "qthzhl_rate"
      "其他患者管理总额占比" -> "qthzgl_rate"
      "手术中意外损伤" -> "ssywss_num"
      "手术中意外切割" -> "ssywqg_num"
      "手术中意外针刺" -> "ssywzc_num"
      "手术中意外穿孔" -> "ssywck_num"
      "手术中意外出血" -> "ssywcx_num"
      "手术中体内遗留异物" -> "ssylyw_num"
      "手术中无菌预防措施的失败" -> "sswjsb_num"
      "手术中操作不当" -> "ssczbd_num"
      "手术中意外损伤占比" -> "ssywss_rate"
      "手术中意外切割占比" -> "ssywqg_rate"
      "手术中意外针刺占比" -> "ssywzc_rate"
      "手术中意外穿孔占比" -> "ssywck_rate"
      "手术中意外出血占比" -> "ssywcx_rate"
      "手术中体内遗留异物占比" -> "ssylyw_rate"
      "手术中无菌预防措施的失败占比" -> "sswjsb_rate"
      "手术中操作不当比例" -> "ssczbd_rate"
      "治疗中意外损伤" -> "zlywzl_num"
      "治疗中意外切割" -> "zlywqg_num"
      "治疗中意外针刺" -> "zlywzc_num"
      "治疗中意外穿孔" -> "zlywck_num"
      "治疗中意外出血" -> "zlywcx_num"
      "治疗中体内遗留异物" -> "zlylyw_num"
      "治疗中无菌预防措施的失败" -> "zlwjsb_num"
      "治疗中操作不当" -> "zlczbd_num"
      "治疗中意外损伤占比" -> "zlywzl_rate"
      "治疗中意外切割占比" -> "zlywqg_rate"
      "治疗中意外针刺占比" -> "zlywzc_rate"
      "治疗中意外穿孔占比" -> "zlywck_rate"
      "治疗中意外出血占比" -> "zlywcx_rate"
      "治疗中体内遗留异物占比" -> "zlylyw_rate"
      "治疗中无菌预防措施的失败占比" -> "zlwjsb_rate"
      "治疗中操作不当比例" -> "zlczbd_rate"
      "输注后感染" -> "szh_num"
      "操作后伤口感染" -> "czh_num"
      "手术后切口感染" -> "ssh_num"
      "肾透析感染" -> "stx_num"
      ...
      "入组率" -> "drg_rate"
      "输血总人数" -> "blood_num"
      "A型血型患者总人数" -> "ablood_num"
      "B型血型患者总人数" -> "bblood_num"
      "AB型血型患者总人数" -> "abblood_num"
      "O型血型患者总人数" -> "oblood_num"
      "未查血型患者总人数" -> "wcblood_num"
      "输血人数占比" -> "blood_rate"
      "A型血型患者人数占比" -> "ablood_rate"
      "B型血型患者人数占比" -> "bblood_rate"
      "AB型血型患者人数占比" -> "abblood_rate"
      "O型血型患者人数占比" -> "oblood_rate"
      "未查血型患者人数占比" -> "wcblood_rate"
      "麻醉总人数" -> "mz_num"
      "有手术无麻醉患者总人数" -> "wmz_num"
      "全身麻醉患者总人数" -> "qsmz_num"
      "吸入麻醉（气管内插管、喉罩、面罩）患者总人数" -> "xrmz_num"
      "静脉麻醉（全凭静脉麻醉）患者总人数" -> "jmmz_num"
      "基础麻醉（直肠注入、肌肉注射）患者总人数" -> "jcmz_num"
      "区域麻醉患者总人数" -> "qymz_num"
      "椎管内麻醉患者总人数" -> "zgnmz_num"
      "麻醉人数占比" -> "mz_rate"
      "有手术无麻醉患者总人数占比" -> "wmz_rate"
      "全身麻醉患者总人数占比" -> "qsmz_rate"
      "吸入麻醉（气管内插管、喉罩、面罩）患者总人数占比" -> "xrmz_rate"
      "静脉麻醉（全凭静脉麻醉）患者总人数占比" -> "jmmz_rate"
      "基础麻醉（直肠注入、肌肉注射）患者总人数占比" -> "jcmz_rate"
      "区域麻醉患者总人数占比" -> "qymz_rate"
      "椎管内麻醉患者总人数占比" -> "zgnmz_rate"
      "蛛网膜下-硬膜外复合麻醉患者总人数" -> "ymwfh_num"
      "复合麻醉患者总人数" -> "fhmz_num"
      "不同药物的复合：普鲁卡因静脉复合全麻，神经安定镇痛麻醉等患者总人数" -> "btywfh_num"
      "不同方法的复合：静吸复合全麻，针药复合麻醉，全身-硬膜外复合麻醉，脊髓-硬膜外复合麻醉等患者总人数" -> "btfffh_num"
      "特殊方法的复合：全麻复合全身降温（低温麻醉）， 控制性降压等患者总人数" -> "tsfffh_num"
      "静吸复合麻醉患者总人数" -> "jxfh_num"
      "其他麻醉患者总人数" -> "qtmz_num"
      "蛛网膜下-硬膜外复合麻醉患者总人数占比" -> "ymwfh_rate"
      "复合麻醉患者总人数占比" -> "fhmz_rate"
      "不同药物的复合：普鲁卡因静脉复合全麻，神经安定镇痛麻醉等患者总人数占比" -> "btywfh_rate"
      "不同方法的复合：静吸复合全麻，针药复合麻醉，全身-硬膜外复合麻醉，脊髓-硬膜外复合麻醉等患者总人数占比" -> "btfffh_rate"
      "特殊方法的复合：全麻复合全身降温（低温麻醉）， 控制性降压等患者总人数占比" -> "tsfffh_rate"
      "静吸复合麻醉患者总人数占比" -> "jxfh_rate"
      "其他麻醉患者总人数占比" -> "qtmz_rate"
      "蛛网膜下腔阻滞患者总人数" -> "zwmx_num"
      "蛛网膜下腔阻滞患者总人数占比" -> "zwmx_rate"
      "硬膜外间隙阻滞（含骶管阻滞）患者总人数" -> "ymw_num"
      "硬膜外间隙阻滞（含骶管阻滞）患者总人数占比" -> "ymw_rate"
      "神经及神经丛阻滞患者总人数" -> "sj_num"
      "神经及神经丛阻滞患者总人数占比" -> "sj_rate"
      "臂丛阻滞及上肢神经阻滞患者总人数" -> "bc_num"
      "腰骶神经丛阻滞及下肢神经阻滞患者总人数" -> "yz_num"
      "躯干神经阻滞：肋间神经阻滞患者总人数" -> "qg_num"
      "椎旁神经阻滞患者总人数" -> "zp_num"
      "会阴神经阻滞患者总人数" -> "per_num"
      "交感神经阻滞：星状神经节阻滞患者总人数" -> "jg_num"
      "胸腰交感神经阻滞患者总人数" -> "xy_num"
      "脑神经阻滞：三叉神经阻滞、舌咽神经阻滞患者总人数" -> "n_num"
      "臂丛阻滞及上肢神经阻滞患者总人数占比" -> "bc_rate"
      "腰骶神经丛阻滞及下肢神经阻滞患者总人数占比" -> "yz_rate"
      "躯干神经阻滞：肋间神经阻滞患者总人数占比" -> "qg_rate"
      "椎旁神经阻滞患者总人数占比" -> "zp_rate"
      "会阴神经阻滞患者总人数占比" -> "per_rate"
      "交感神经阻滞：星状神经节阻滞患者总人数占比" -> "jg_rate"
      "胸腰交感神经阻滞患者总人数占比" -> "xy_rate"
      "脑神经阻滞：三叉神经阻滞、舌咽神经阻滞患者总人数占比" -> "n_rate"
      "新生儿总数" -> "baby_num"
      "新生儿总数占比" -> "baby_rate"
      "新生儿男孩数" -> "boy_num"
      "新生儿男孩数占比" -> "boy_rate"
      ...
      "神经系统缺陷总例数" -> "sjqx_num"
      "呼吸系统缺陷总例数" -> "hxqx_num"
      "血液循环系统缺陷总例数" -> "xyqx_num"
      "运动系统缺陷总例数" -> "ydqx_num"
      "内分泌系统缺陷总例数" -> "nfmqx_num"
      "泌尿系统缺陷总例数" -> "mnqx_num"
      "生殖系统缺陷总例数" -> "szqx_num"
      "消化系统缺陷总例数占比" -> "xhqx_rate"
      "神经系统缺陷总例数占比" -> "sjqx_rate"
      "呼吸系统缺陷总例数占比" -> "hxqx_rate"
      "血液循环系统缺陷总例数占比" -> "xyqx_rate"
      "运动系统缺陷总例数占比" -> "ydqx_rate"
      "内分泌系统缺陷总例数占比" -> "nfmqx_rate"
      "泌尿系统缺陷总例数占比" -> "mnqx_rate"
      "生殖系统缺陷总例数占比" -> "szqx_rate"
    end
  end
end

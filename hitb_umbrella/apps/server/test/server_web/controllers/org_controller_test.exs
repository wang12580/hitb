defmodule ServerWeb.OrgControllerTest do
  use ServerWeb.ConnCase

  @valid_attrs %{county: "0000", city: "123456", code: "77", name: "77", email: "222", is_show: true,
is_ban: true, level: "0000", person_name: "0000", province: "000", tel: "000", type: "000", stat_org_name: 1}
  ...
  test "POST /show", %{conn: conn} do
    Server.Repo.insert!(Map.merge(%Server.Org{}, @valid_attrs))
    org = Server.Repo.get_by(Server.Org, city: @valid_attrs.city)

defmodule HitbserverWeb.OrgView do
  use HitbserverWeb, :view

  def render("index.json", %{org: org, page_num: page_num, page_list: page_list}) do
    %{data: render_many(org, HitbserverWeb.OrgView, "org.json"), page_num: page_num, page_list: page_list}
  end

  def render("show.json", %{org: org, success: success}) do
    %{data: render_one(org, HitbserverWeb.OrgView, "org.json"), success: success}
  end

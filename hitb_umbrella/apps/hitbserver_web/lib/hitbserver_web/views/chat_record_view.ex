defmodule HitbserverWeb.ChatRecordView do
  use HitbserverWeb, :view

  def render("index.json", %{chat_record: chat_record}) do
    %{data: render_many(chat_record, HitbserverWeb.ChatRecordView, "chat_record.json")}
  end

  def render("show.json", %{chat_record: chat_record}) do
    %{data: render_one(chat_record, HitbserverWeb.ChatRecordView, "chat_record.json")}
  end
